 ...
 */
module.exports.findAndModify = function (collectionName, collectionQuery, collectionData) {
    return new Promise(function (resolve, reject) {
        db.collection(collectionName, function (err, collection) {
            collection.findAndModify(collectionQuery,
                [],
                {$set: collectionData},
 ...
 * @param collectionData - The data to update
 */
module.exports.updateMany = function (collectionName, collectionQuery, collectionData) {
    return new Promise(function (resolve, reject) {
        db.collection(collectionName, function (err, collection) {
            collection.updateMany(collectionQuery,
                {$set: collectionData},
                {upsert:false},
                function (err, result) {
                    if (err) {
...
module.exports.findLatest = function (collectionName) {
    return new Promise(function (resolve, reject) {
        db.collection(collectionName, function (err, collection) {
            collection.find().limit(1).sort({$natural:-1}).nextObject(function(err, result) {
                if (err) {
...
module.exports.findAndSort = function (collectionName, sortQuery) {
    return new Promise(function (resolve, reject) {
        db.collection(collectionName, function (err, collection) {
            collection.find().sort(sortQuery).toArray(function (err, result) {
                if (err) {
